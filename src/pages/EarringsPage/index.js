...
import styles from "./EarringsPage.module.scss";
...
function EarringPage() {
  ...
  const [categoryName, setCategoryName] = useState("Trang sức hoa tai");
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const filteredProducts = data.filter(
          (product) => product.categoryName === "Trang sức hoa tai"
        );
