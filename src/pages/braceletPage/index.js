...
import styles from "./braceletPage.module.scss";
...
function BraceletPage() {
  ...
  const [categoryName, setCategoryName] = useState("Trang sức vòng tay");
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const filteredProducts = data.filter(
          (product) => product.categoryName === "Trang sức vòng tay"
        );
