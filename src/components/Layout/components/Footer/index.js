    ...
    <div className={cx("footer-wrapper")}>
      <div className={cx("footer-introduce")}>
        <div className={cx("value")}>
          ...
          <p>
            {" "}
            Trang sức tinh tế, được chế tác từ chất liệu cao cấp, mang đậm dấu
            ấn cá nhân và vẻ đẹp vượt thời gian.
          </p>
        </div>
        ...
        <div className={cx("value")}>
          ...
          <p>
            Hỗ trợ vận chuyển toàn quốc và quốc tế. Hỗ trợ giao hàng gấp trong
            vòng 1 -2 giờ (có tính phí) khu vực HCM.
          </p>
        </div>
        ...
        <div className={cx("value")}>
          ...
          <p>
            Sản phẩm được bán với giá gốc xuất xưởng không qua trung gian nên rẻ
        ...
        <div className={cx("value")}>
          ...
          <h2>Hỗ trợ 24/7</h2>
          <p>
            Phục vụ 24/7 cho trải nghiệm mua sắm của khách hàng không bị gián
            đoạn.
          </p>
        </div>
      ...
      <div className={cx("footer-register")}>
        ...
        <div className={cx("form-register")}>
          ...
          <button className={cx("btnRegister")}>
            <FontAwesomeIcon icon={faEnvelope} /> Đăng ký
          </button>
        </div>
      </div>
      ...
      <div className={cx("footer")}>
        <div style={{ width: "400px" }} className={cx("footer-column")}>
          ...
          <p>
            Giấy chứng nhận Đăng ký Kinh doanh số 0311761046 do Sở Kế hoạch và
            Đầu tư Thành phố Hồ Chí Minh, năm 2012.
          </p>
          <hr />
          <p>
        ...
        <div className={cx("footer-column")}>
          ...
          <p className={cx("hotline")}>
            <FontAwesomeIcon icon={faHeadset} className={cx("icon-hotline")} />
            1900 63 60 76
          </p>
          <div className={cx("social-icons")}>
            ...
            <div className={cx("societyn")}>
              <a href="https://zalo.com" target="_blank" rel="noreferrer">
                <img
                  src="https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/5f/06/af/5f06afa8-8bdf-4003-863e-c79b96492997/AppIcon-0-0-1x_U007emarketing-0-7-0-0-85-220.png/1200x630wa.png"
                  alt="Zalo"
                />
              </a>
            </div>
